...
def setup_api_gateway():
    ...
    parser.add_argument('--function-name', default="telegram-ai-assistant",
                        help='Lambda function name (default: telegram-ai-assistant)')
    parser.add_argument('--api-name', default="telegram-ai-webhook-api",
